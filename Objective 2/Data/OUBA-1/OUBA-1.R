...
##
## Focal lineage: Ouachita Bass lineage
##
## This script:
...
# paths
# -----------------------------
out_dir  <- file.path("/Users/johnmccall/Library/CloudStorage/OneDrive-TheOhioStateUniversity/Spring_2026/Landgen_DGS/DGS-Patterns-of-Fish-Diversity/DGS-Patterns-of-Fish-Diversity/Objective 2/Data", "OUBA-1")
...
dataset_code   <- "OUBA-1"
focal_taxon    <- "OB"
river_order    <- c("Little_Missouri_River_AR", "Caddo_River_AR", "Ouachita_River_AR", "Eastern_Saline_River_AR")
site_name_map  <- c("Little_Missouri_River_AR" = "Little Missouri River", "Caddo_River_AR" = "Caddo River", "Ouachita_River_AR" = "Ouachita River", "Eastern_Saline_River_AR" = "Eastern Saline River")
drop_stage1_n  <- c("Eastern_Saline_River_AR" = 2)
drop_stage2_n  <- c("Ouachita_River_AR" = 2)
drop_stage3_n  <- c()
...
save(
  OUBA_1_fst,
  OUBA_1_coords,
  file = file.path("/Users/johnmccall/Library/CloudStorage/OneDrive-TheOhioStateUniversity/Spring_2026/Landgen_DGS/DGS-Patterns-of-Fish-Diversity/DGS-Patterns-of-Fish-Diversity/Objective 2/Data/OUBA-1/data/OUBA-1.RData")
)